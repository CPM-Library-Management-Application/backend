...
from .views import books_view, library_view, library_view_by_id, book_view, lease_book, return_book,add_book_to_library, reserve_book, search_book, user_books
...
urlpatterns = [
    ...
    path('books/user/<int:user_id>', user_books),
